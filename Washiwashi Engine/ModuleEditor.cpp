    ...
    if (ImGui::BeginMenu("Game Object"))
    {
        ...
        if (ImGui::BeginMenu("Create"))
        {
            if (ImGui::MenuItem("Cube"))
            {
                ...
                cube->LocateComponent("Assets/Resources/Meshes/Prefabs/SimpleShapes/cube.fbx", Component::Type::MESH);
            }
            if (ImGui::MenuItem("Sphere"))
            {
                GameObject* sphere = App->scene->SpawnGameObject("Sphere", App->scene->root);
                sphere->CreateComponent(Component::Type::MESH);
                sphere->LocateComponent("Assets/Resources/Meshes/Prefabs/SimpleShapes/sphere.fbx", Component::Type::MESH);
            }
            if (ImGui::MenuItem("Cylinder"))
            {
                GameObject* cylinder = App->scene->SpawnGameObject("Cylinder", App->scene->root);
                cylinder->CreateComponent(Component::Type::MESH);
                cylinder->LocateComponent("Assets/Resources/Meshes/Prefabs/SimpleShapes/cylinder.fbx", Component::Type::MESH);
            }
            if (ImGui::MenuItem("Pyramid"))
            {
                GameObject* pyramid = App->scene->SpawnGameObject("Pyramid", App->scene->root);
                pyramid->CreateComponent(Component::Type::MESH);
                pyramid->LocateComponent("Assets/Resources/Meshes/Prefabs/SimpleShapes/pyramid.fbx", Component::Type::MESH);
            }
            if (ImGui::MenuItem("Plane"))
            {
                GameObject* plane = App->scene->SpawnGameObject("Plane", App->scene->root);
                plane->CreateComponent(Component::Type::MESH);
                plane->LocateComponent("Assets/Resources/Meshes/Prefabs/SimpleShapes/plane.fbx", Component::Type::MESH);
            }
            ImGui::EndMenu();
        }
        ImGui::EndMenu();
